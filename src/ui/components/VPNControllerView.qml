...
Item {
    ...
    Column{
        ...
        function handleMultilineText() {
            ...
            const subTitleIsWrapped = (logoSubtitle.visible && logoSubtitle.lineCount > 1 || (connectionStability.visible && connectionStability.flow === Grid.TopToBottom));
